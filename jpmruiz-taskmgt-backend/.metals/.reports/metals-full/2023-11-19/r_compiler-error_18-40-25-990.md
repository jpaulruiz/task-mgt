file:///D:/Practice/ScalaXVue/jpmruiz-pekko/jpmruiz-pekko/app/pekko/PongActor.scala
### file%3A%2F%2F%2FD%3A%2FPractice%2FScalaXVue%2Fjpmruiz-pekko%2Fjpmruiz-pekko%2Fapp%2Fpekko%2FPongActor.scala:5: error: ; expected but : found
object PongActor:
                ^
...
action parameters:
uri: file:///D:/Practice/ScalaXVue/jpmruiz-pekko/jpmruiz-pekko/app/pekko/PongActor.scala
text:
```scala
package pekko
...
object PongActor:
    def props = 
        ...
        // Props.create(classOf[PongActor], out)
        // Props(new PongActor(out,manager))
...
class PongActor extends Actor:
    ...
    def receive: Actor.Receive = 
        case SayHello(name) => 
            sender() ! PingActor.FromManager(s"Hello, $name!")
```
